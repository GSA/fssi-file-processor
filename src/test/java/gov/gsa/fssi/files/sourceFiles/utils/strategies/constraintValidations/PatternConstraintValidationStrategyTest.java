...
public class PatternConstraintValidationStrategyTest {
	...
	public void testNull() {
		...
		FieldConstraint fieldConstraint = MockFieldConstraint.make(FieldConstraint.TYPE_PATTERN, "Yes|No", 2);	
		...
		//data.setStatus(2);
		Assert.assertEquals("failure - PatternConstraintValidationStrategyTest did not catch error",0, data.getMaxErrorLevel());
		Assert.assertEquals("failure - PatternConstraintValidationStrategyTest did not make failure", true, data.getStatus());		
	}
	...
	public void testOrPatternExactMatch() {
		...
		context.validate(field, fieldConstraint, data);
		//data.setStatus(2);
		Assert.assertEquals("failure - PatternConstraintValidationStrategyTest caughtError", 0, data.getMaxErrorLevel());
		Assert.assertEquals("failure - PatternConstraintValidationStrategyTest did not pass", true, data.getStatus());				
	}	
	...
	public void testOrPatterNoMatch() {
		...
		context.validate(field, fieldConstraint, data);
		//data.setStatus(2);
		Assert.assertEquals("failure - PatternConstraintValidationStrategyTest caughtError", fieldConstraint.getLevel(), data.getMaxErrorLevel());
		Assert.assertEquals("failure - PatternConstraintValidationStrategyTest did not pass", false, data.getStatus());				
	}	
	...
	public void testREGEXPatterMatch() {
		...
		FieldConstraint fieldConstraint = MockFieldConstraint.make(FieldConstraint.TYPE_PATTERN, "([A-Z])\\w+", 2);	
		SchemaField field = MockSchemaField.make("PATTERN", SchemaField.TYPE_STRING, fieldConstraint);
		Data data = MockData.make("YES");
	...
	public void testREGEXPatterWarning() {
		...
		FieldConstraint fieldConstraint = MockFieldConstraint.make(FieldConstraint.TYPE_PATTERN, "([A-Z])\\w+", 1);	
		SchemaField field = MockSchemaField.make("PATTERN", SchemaField.TYPE_STRING, fieldConstraint);
		Data data = MockData.make("123345");
	...
	public void testAlreadyFailed() {
		...
		FieldConstraint fieldConstraint = MockFieldConstraint.make(FieldConstraint.TYPE_PATTERN, "true", 2);	
