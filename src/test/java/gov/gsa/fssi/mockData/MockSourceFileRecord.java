...
public class MockSourceFileRecord {
	...
	public static SourceFileRecord make(HashMap<Integer, String> dataMap){
		...
		while (dataMapIterator.hasNext()) {
			Map.Entry<Integer, String> dataMapIteratorPairs = (Map.Entry)dataMapIterator.next();
			sourceFileRecord.addData(MockData.make(dataMapIteratorPairs.getValue(),dataMapIteratorPairs.getKey()));
		}
