...
public class MinLengthConstraintValidationStrategy implements
		ConstraintValidationStrategy {
	static final Logger logger = LoggerFactory.getLogger(MinLengthConstraintValidationStrategy.class);
	@Override
