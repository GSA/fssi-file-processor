...
public class Provider extends File{
	...
	/**
	 * id of the provider, which uniquely identifies the provider. Not currently used
	 */
	private String providerId = null;
	/**
	 * Name of the provider, which has a one-to-many relationship with the providerIdentifier
	 */
	 ...
	 * @see gov.gsa.fssi.files.File#File(String)
	 */
	...
	/**
	 * @param contactEmail String contactEmail to set
	 */
