...
public class ProviderManager {
	...
	public ProviderManager(){
		buildProviders("./working/");
	}
	
	public ProviderManager(String providerDirectory){
		buildProviders(providerDirectory);
	}	
	
	
	
	private ArrayList<Provider> buildProviders(String providerDirectory) {
		...
		try {
			wb = WorkbookFactory.create(new File(providerDirectory + "providers.xlsx"));
